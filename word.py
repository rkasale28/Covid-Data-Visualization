...
# img = Image.open("C:\\Users\\Rohit\\Documents\\Self Learning\\Streamlit\\img\\maharastra_map.png")
# mask = np.array(img)
...
plt.imshow(wc.recolor(color_func=purple_color_func, random_state=3), interpolation="bilinear")
plt.axis("off")
plt.show()
st.pyplot()

map_coloring = np.array(Image.open("C:\\Users\\Rohit\\Documents\\Self Learning\\Streamlit\\img\\color.png"))
map_colors = ImageColorGenerator(map_coloring)
plt.imshow(wc.recolor(color_func=map_colors, random_state=3), interpolation="bilinear")
plt.axis("off")
plt.show()
st.pyplot()
